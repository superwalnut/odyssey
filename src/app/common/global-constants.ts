...
export class GlobalConstants {
  ...
  public static rateTraining: number = 45;
  public static rateTrainingCommitte: number = 35;
  ...
  public static homepageQuotes = [
    ...
    {
      line: "即使是最小的事情，也要倾注你的心、你的思想和你的灵魂。这就是成功的秘密",
      people: "",
    },
    {
      line: "踢踢腿、弯弯腰，病魔吓了逃；打打拳，练练操，寿星见了笑",
      people: "",
    },
    { line: "腐蚀人性最可怕的东西是惰性，而体育是惰性的天敌", people: "" },
    {
      line: "生命在于矛盾，在于运动，一旦矛盾消除，运动停止，生命也就结束了",
      people: "",
    },
    {
      line: "一滴水只有放进大海里才永远不会干涸，一个人只有当他把自己和集体事业融合在一起的时候才能最有力量",
      people: "",
    },
    ...
    {
      line: "你见过凌晨四点的洛杉矶吗？我见过，那是我每天开始训练的时间",
      people: "",
    },
    {
