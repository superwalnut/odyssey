...
@Component({
  selector: 'app-hbc-competition2021',
  templateUrl: './hbc-competition2021.component.html',
  styleUrls: ['./hbc-competition2021.component.scss']
})
export class HbcCompetition2021Component extends BaseComponent implements OnInit {
